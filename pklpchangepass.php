...
?>
	...
	<div class="col-lg-4 col-lg-offset-4 blkg">
		...
		else
		{
			...
			if($_POST['user']==''||$_POST['pass']==''||$_POST['passb']==''||$_POST['passk']=='')
			{
				echo"Ada data yang belum terisi, silahkan <a href=\"pklchangepass.php\">kembali</a>";
			}

			if($user!=$_SESSION['user'])
			{
				echo"Bukan Username anda yang anda masukkan!, silahkan <a href=\"pklchangepass.php\">kembali</a>";
			}
			...
			{	
				...
				if ($result)
				{
					...
					if ($row[3] == $pass) 
					{
						...
						if($passb!=$passk)
						{
							echo "Password baru anda tidak sama, silahkan <a href=\"pklchangepass.php\">kembali</a><br>";
						}
						else
						{
							$query = "UPDATE user SET password=\"$passb\" WHERE username='" . $user . "'";
							$result = mysqli_query($conn, $query);
							if ($result)
							{
								echo "Selamat password anda sudah terganti!";
								echo "<br>Kembali ke <a href=\"pklmenu.php\">Menu</a>";
							}
							else
							{
								echo "Ubah Password gagal!<br>"; 
								echo "Perbaiki <a href=\"pklchangepass.php\">disini</a>";
							}
						}
					}
					else 
					{
						echo "Kombinasi login username dan password salah<br>"; 
						echo "Perbaiki <a href=\"pklchangepass.php\">disini</a>";
					}
				}
			}
