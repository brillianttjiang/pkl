  ...
  <div class=\"container-fluid\">
	...
	<br>
		...
		else
		{
			...
			$querykirim = "SELECT * FROM kirim NATURAL JOIN user WHERE status=0 OR status=1 order by idkirim desc";
			...
			for($x=1;$x<=$jumlahkirim;$x++)
			{
				...
				$tanggalorder[$x]=$rowkirim["tanggalorder"];
			}
